 ...
 * security.
 */
export declare const DEFAULT_DEV_SECRET = "cloudflare-access-dev-secret-do-not-use-in-production";
/** Name of the cookie that stores the JWT. */
export declare const COOKIE_NAME = "CF_Authorization";
...
export declare const EMAIL_HEADER = "cf-access-authenticated-user-email";
/** Header containing the authenticated user's unique ID. */
export declare const USER_HEADER = "cf-access-user";
/**
 ...
 * verification.
 */
export declare function verifyDevJwt(token: string, secret?: string): Promise<VerifiedToken | null>;
/**
 * Verify a JWT against Cloudflare Access's remote JWKS endpoint.
 *
 * When `audience` is provided the `aud` claim is also verified.
 */
export declare function verifyAccessJwt(token: string, teamDomain: string, audience?: string): Promise<VerifiedToken | null>;
/** Pull the required claims out of a verified payload. */
export declare function extractClaims(payload: JWTPayload): VerifiedToken | null;
/**
 ...
 */
export declare function buildCookieHeader(token: string, isSecure: boolean): string;
/**
 ...
 */
export declare function clearCookieHeader(): string;
/**
 * Parse the value of the `CF_Authorization` cookie from a `Cookie`
 * header string.  Returns `undefined` when the cookie is absent.
 */
export declare function parseCookie(cookieHeader: string | null | undefined): string | undefined;
