...
Use this workflow to implement a GitHub issue from `adrianhall/cloudflare-auth` with a single-responsibility pull request.
...
1. Load project context.
   ...
   Read the specs in `README.md`, `AGENTS.md` if present, `package.json`, and any files directly referenced by the issue. Load relevant skills before implementation. For Cloudflare, Workers, Wrangler, Hono, OpenAPI, or auth work, retrieve current documentation before writing code.
